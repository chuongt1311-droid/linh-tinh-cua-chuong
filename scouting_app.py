...
@st.cache_data
def load_scouts():
    scouts = pd.read_csv('PERFECT_scouting_data_2026.csv')
    scouts = scouts[scouts['pos_'] == 'MF'].copy()
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    with h1:
        ...
        ast = int(row.get('Performance_Ast', 0))
        mins = int(row.get('Playing Time_Min', 0))
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    if player_a == player_b:
        ...
        for bio_col, p_row, p_grade, p_color in [
            ...
            with bio_col:
                gls = int(p_row.get('Performance_Gls', 0))
                ast = int(p_row.get('Performance_Ast', 0))
                mins = int(p_row.get('Playing Time_Min', 0))
